...
| **Karten** | **Kartenwerkstatt** mit fotorealistischem Stil: Räume, runde Räume, Polygone, Gänge und Höhlen aufziehen – texturierte Böden, Wände mit Schatten, Dächer und Raster entstehen automatisch; **über 300 Objekte** (258 von oben gerenderte 3D‑Modelle von Poly Haven + Türen, Treppen, Säulen, Altäre, Teppiche, Feuer, Zauberkreise …) mit Suche und Kategorien, **78 Texturen** für Böden, Wege, Gelände, Wände und Dächer, **Streu‑Pinsel** für Bäume, Gras, Steine und Trümmer, **Zwischenwände** (halten Bewegung, Sicht und Zauberflächen auf – Türen darauf öffnen sie), **Licht & Dunkelheit** (Fackeln, Feuer, Magie leuchten von selbst), Wasser, Lava, Sumpf und Eis mit weichen Ufern, Raumnummern mit verknüpften Notizen, 5 Stile (inkl. der klassischen Dungeon‑Scrawl‑Optik), 8 Generatoren (Dungeon, Höhle, Taverne, Tempel, Lichtung, Wald, Dorf), **eigene Objektpakete importieren** (bleiben auf dem Gerät, für Mitspieler wird ein Kartenbild gebacken), Rückgängig, PNG‑Export, Bild als Vorlage, Spielmodus mit Tokens, **Nebel des Krieges** und Maßband. Dazu Weltkarten mit Pins (Farbcode‑Notizen) und KI‑gemalte Karten |
...
| **Bedienung** | Eine **Suche für alles** (Notizen und Befehle, Strg+K; `>` = nur Befehle), beschriftete Seitenleiste auf Tablet/PC, Schubladen am Handy per Wischen; „Karten“ fragt „Karten oder Kampf?“ und bringt dich direkt zur laufenden Kampfkarte |
